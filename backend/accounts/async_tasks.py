...
from .invite_mailer import send_html_email, send_invite_email, send_html_email_batch
...
def send_html_email_batch_async(*, payloads: list[dict]):
    return _executor.submit(send_html_email_batch, payloads=payloads)
